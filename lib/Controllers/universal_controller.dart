...
import '../Models/my_player_model.dart';
import '../Models/my_player_model2.dart';
import '../Models/my_team_modal.dart';

class UniversalController extends GetxController {
  List<MyTeamModel> teams = [];
  static List<MyPlayerModel1> players1 = [];
...
void fetchPlayerList() async {
  print('FETCH Player1');
  players1 = await ApiService.fetchAllPlayers();
